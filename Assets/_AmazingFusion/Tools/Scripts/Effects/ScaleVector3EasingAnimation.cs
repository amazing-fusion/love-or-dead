...
namespace com.AmazingFusion {
    public class ScaleVector3EasingAnimation : OptimizedBehaviour, IEffectable {
        ...
        public event Action<ScaleVector3EasingAnimation> OnStart;
        public event Action<ScaleVector3EasingAnimation> OnUpdate;
